...
class ColorContrastGetter
{
   ...
   *
   */
  public static function evaluate($color_1, $color_2)
  {
    $eval_array = array();
    $color_1_rgb = array_map(function($x) {return $x/255;}, convert2rgb($color_1));
    $color_2_rgb = array_map(function($x) {return $x/255;}, convert2rgb($color_2));
   ...
   */
  private static function _get_luminance($rgb)
  {
    // gamma correct rgb
