 ...
 * @param  Number  $parent_size
 * @param  integer $root_size   [Optional, default is 12pt, can be overriden]
 * @return Number               [converted to pt]
 */

function convert2pt($tag_name, $size_value, $parent_size, $root_size = 12) {
